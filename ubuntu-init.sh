...
apt-get update -y && apt install php7.2-cli -y && apt-get install php-gd -y && apt-get install php-curl -y && apt-get install php-mbstring -y && apt-get install php-xml -y && apt install mariadb-client-core-10.1 -y && apt install mysql-client-5.7 -y
# Install zip/unzip
apt-get install zip -y && apt-get install unzip -y
# Install make
apt install make -y
# Install Docker
apt-get install -y docker.io && apt install docker-compose -y
